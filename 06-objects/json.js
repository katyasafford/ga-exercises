...
grungeAlbumsBack.albums.forEach(function (x) {
  console.log("Album: " + x.name);
  console.log("Artist: " + x.artist);
  console.log("Units sold: " + x.unitsSold);
});

// [].forEach(function(element)) {
//   runs for each element of array
// }
...
// ]
//
// //you can run it on array, not on object
// pokemon.forEach(function(pokemon) {
//   console.log(pokemon);
// })

//for homework - loop with for each:
...
// var emptyArray = [];
// data.items.forEach(function(item) {
//   emptyArray.push(item.title + ' ' + item.date_taken);
// });
